...
class OrderPositionsControllerTest < ActionController::TestCase
  ...
  test "should create order_position" do
    assert_difference('OrderPosition.count') do
      post :create, order_position: { amount: @order_position.amount, completed: @order_position.completed, ordinal: @order_position.ordinal, price: @order_position.price, references: @order_position.references, references: @order_position.references }
    end
  ...
  test "should update order_position" do
    patch :update, id: @order_position, order_position: { amount: @order_position.amount, completed: @order_position.completed, ordinal: @order_position.ordinal, price: @order_position.price, references: @order_position.references, references: @order_position.references }
    assert_redirected_to order_position_path(assigns(:order_position))
  end
